...
lines = ''
with open('xjustiz_3_2_1_mod.txt', '+r') as f:
    lines = f.readlines()
...
start_tag = 'complexType '
end_tags_lst = ['Dieser Typ ist eine Erweiterung', 'Diese Nachricht ist eine Erweiterung', 'Der Grunddatensatz (GDS)', 'Kindelement', 'Fachmodul']
type_gds = 'Type.GDS.'
filename = 'all_xjustix_complex_types.txt'
